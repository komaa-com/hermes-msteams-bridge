...
package `hermes_msteams_bridge`, Hermes plugin name `msteams_call`) adds **Microsoft
...
flowchart LR
    ...
    Plugin["msteams_call plugin (in Hermes)<br/>the local WS server + the call brain"]
