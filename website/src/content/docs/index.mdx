...
- **[Getting Started](/hermes-msteams-bridge/getting-started/)** - install, enable, and place your first call.
- **[Connecting to StandIn](/hermes-msteams-bridge/connecting-to-standin/)** - the connection model, the
  three tiers (sandbox / free / subscription), and the shared secret.
- **[Architecture](/hermes-msteams-bridge/architecture/)** - the system design: call lifecycle, the handler
  abstraction, the audio pipeline, module map, and the trust model.
- **[Configuration Reference](/hermes-msteams-bridge/configuration-reference/)** - every config key, env var,
  and default.
- **[Voice Modes & Providers](/hermes-msteams-bridge/voice-modes-and-providers/)** - realtime vs streaming;
  OpenAI vs Azure; VAD tuning.
- **[Wire Protocol](/hermes-msteams-bridge/wire-protocol/)** - the WebSocket contract, HMAC, and message
  tables.
- **[Features](/hermes-msteams-bridge/features/)** - the full capability tour.
- **[Outbound Calls](/hermes-msteams-bridge/outbound-calls/)** - "call me back" / placing calls.
- **[Troubleshooting](/hermes-msteams-bridge/troubleshooting/)** - common problems and fixes.
- **[Contributing](/hermes-msteams-bridge/contributing/)** - help improve the plugin.
